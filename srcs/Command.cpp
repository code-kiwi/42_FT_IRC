...
/*   Updated: 2025/09/06 02:11:47 by mhotting         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Command.hpp"

Command::Command(Client &client) : _sender(client), _params() {};

Command::Command(Client &client, std::vector<std::string> &params) : _sender(client), _params(params) {}
